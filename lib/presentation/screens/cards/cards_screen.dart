        ...
        child: Column(
          children: [
            Align(
              ...
              child: IconButton(onPressed: (){}, icon: const Icon(Icons.face_2))
            ),
            const Align(
...
class _CardType2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      shape: RoundedRectangleBorder(side: BorderSide(color: colors.outline), borderRadius: const BorderRadius.all(Radius.circular(12))),      
      elevation: elevation,
      child: Padding(
        padding: const EdgeInsets.fromLTRB(10, 5, 10, 10),
        child: Column(
